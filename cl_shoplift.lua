...
AddEventHandler('sw-shoplift:client:startShoplift', function()
        --if timeOut then TriggerEvent('rNotify:NotifyLeft', "you only just", "shoplifted", "generic_textures", "tick", 4000) return end
        ...
        RSGCore.Functions.Progressbar("shoplifting", Config.Translations.ShopliftProgressbar, 12500, false, true, {
